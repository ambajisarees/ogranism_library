/*
================================================================================
LLM CONTEXT & QUERY SPACE — DYNAMIC TABLE PANE (dy_table_pane.dart)
================================================================================
1. DOMAIN & PURPOSE:
   - High-density desktop data table pane component (consolidated from dy_view_table.dart).
   - Encapsulates DynamicDenseTable and exports DyTablePane alias.
================================================================================
*/
...
typedef DyTablePane = DynamicDenseTable;
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                color: widget.headerBackgroundColor ?? colors.card,
                child: Row(
              ...
              if (widget.showSummaryRow) ...[
                shad.Divider(color: colors.border),
                _buildSummaryRow(context, theme, colors),
              ],
            ],
          ),
        );
        ...
        children: parentRow.childRows.map((childRow) {
          return Container(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                if (widget.enableExpansion) const SizedBox(width: 32),
