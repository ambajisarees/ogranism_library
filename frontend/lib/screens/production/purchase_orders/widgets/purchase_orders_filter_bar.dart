...
class PurchaseOrdersFilterBar extends StatelessWidget {
  final Widget categorySelectWidget;
  ...
  Widget build(BuildContext context) {
    ...
    final String recordsLabel = selectedCount > 0
        ...
        : '$displayedRecords of $totalRecords Orders';

    return Row(
      children: [
        // Category Select Dropdown Widget (optional slot)
        categorySelectWidget,
        const shad.DensityGap(shad.gapMd),

        // Compact Surface Pagination / Records Counter Element
        ...
        Expanded(
          child: shad.TextField(
            ...
            placeholder: const Text('Search Order #, Supplier, Broker, Quality...'),
